...
from detectron2.solver import WarmupParamScheduler, ConstCosineParamScheduler
...
def default_constcosine_scheduler(epochs=50, warmup_epochs=0, decay_ratio=100):
    end_val = 1 / decay_ratio
    scheduler = ConstCosineParamScheduler(1, end_val)
...
# default scheduler for detr
lr_constcosine_50ep = default_constcosine_scheduler(50, 0)
lr_constcosine_36ep = default_constcosine_scheduler(36, 0)
lr_constcosine_24ep = default_constcosine_scheduler(24, 0)
lr_constcosine_12ep = default_constcosine_scheduler(12, 0)

# warmup scheduler for detr
# lr_multiplier_50ep_warmup = default_constcosine_scheduler(50, 40, 1e-3)
# lr_multiplier_12ep_warmup = default_constcosine_scheduler(12, 11, 1e-3)
