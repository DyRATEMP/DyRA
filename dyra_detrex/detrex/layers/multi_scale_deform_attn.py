    ...
    def forward(
        ...
        **kwargs
        ...
        if key_padding_mask is not None:
            ...
            val1 = value[:N//2].masked_fill(key_padding_mask[:N//2, ..., None], float(0))
            val2 = value[N//2:].masked_fill(key_padding_mask[N//2:, ..., None], float(0))
            value = torch.cat((val1, val2), dim=0)
