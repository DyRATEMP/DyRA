...
from detectron2.modeling.resizer import DynamicResizer, SimplePredictor
...
model = L(DINO)(
    ...
    resizer=L(DynamicResizer)(
        net=L(SimplePredictor)(
            in_chan=15, device="cuda", num_mlayer=256,
        ),
        image_encoder=L(ResNet)(
            stem=L(BasicStem)(in_channels=3, out_channels=64, norm="FrozenBN"),
            stages=L(ResNet.make_default_stages)(
                depth=18,
                # stride_in_1x1=False,
